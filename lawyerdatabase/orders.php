...
<div class="panel panel-default">
	<div class="panel-heading">
		...
		<?php if($_GET['o'] == 'add') { ?>
  		<i class="glyphicon glyphicon-plus-sign"></i>	Add Case Details
		<?php } else if($_GET['o'] == 'manord') { ?>
			<i class="glyphicon glyphicon-edit"></i> Manage Case Details
		<?php } else if($_GET['o'] == 'editOrd') { ?>
			<i class="glyphicon glyphicon-edit"></i> Edit Case Details
		<?php } ?>
	...
	<div class="panel-body">
		...
		<?php if($_GET['o'] == 'add') { 
  		...
  		<form class="form-horizontal" method="POST" action="php_action/createOrder.php" id="createOrderForm">
			  ...
			  <div class="form-group">
			    <label for="orderDate" class="col-sm-2 control-label">Case Date</label>
			    <div class="col-sm-10">
			  ...
			  <table class="table" id="productTable">
			  	<thead>
			  		<tr>			  			
			  			<th style="width:40%;">Lawyer</th>
			  			<th style="width:20%;">Rating</th>
			  			<th style="width:10%;">Cases Handled</th>
			  			<th style="width:15%;">No.of Case Handled</th>			  			
			  			<th style="width:25%;">Fees</th>			  			
			  ...
			  <div class="col-md-6">
			  	<div class="form-group">
				    <label for="subTotal" class="col-sm-3 control-label">Case Estimation</label>
				    <div class="col-sm-9">
				   ...
				   <!--/form-group-->			  
				  <div class="form-group">
				    <label for="totalAmount" class="col-sm-3 control-label">Total Fees</label>
				    <div class="col-sm-9">
				  ...
				  <div class="form-group">
				    <label for="discount" class="col-sm-3 control-label">Handling Rate</label>
				    <div class="col-sm-9">
				      <input type="text" class="form-control" id="discount" name="discount" onkeyup="discountFunc()" autocomplete="off" />
				    </div>
				  </div> <!--/form-group-->	
				  <div class="form-group">
				    <label for="grandTotal" class="col-sm-3 control-label">Case Archivement</label>
				    <div class="col-sm-9">
				  ...
				  <div class="form-group">
				    <label for="vat" class="col-sm-3 control-label gst">Case Handled</label>
				    <div class="col-sm-9">
			  ...
			  <div class="col-md-6">
			  	<div class="form-group">
				    <label for="paid" class="col-sm-3 control-label">Cases Progress</label>
				    <div class="col-sm-9">
				      <input type="text" class="form-control" id="paid" name="paid" autocomplete="off" onkeyup="paidAmount()" />
				    </div>
				  </div> <!--/form-group-->			  
				  <div class="form-group">
				    <label for="due" class="col-sm-3 control-label">Progress</label>
				    <div class="col-sm-9">
				  ...
				  <div class="form-group">
				    <label for="clientContact" class="col-sm-3 control-label">Case Stages</label>
				    <div class="col-sm-9">
				      <select class="form-control" name="paymentType" id="paymentType">
				      	<option value="">~~SELECT~~</option>
				      	<option value="1">Fully Completed</option>
				      	<option value="2">Case Going on</option>
				      	<option value="3">Not Completed</option>
				      </select>
				    </div>
				  </div> <!--/form-group-->							  
				  <div class="form-group">
				    <label for="clientContact" class="col-sm-3 control-label">Case Status</label>
				    <div class="col-sm-9">
		...
		// /else manage order
  		...
  		<form class="form-horizontal" method="POST" action="php_action/editOrder.php" id="editOrderForm">
			  ...
			  <table class="table" id="productTable">
			  	<thead>
			  		<tr>			  			
			  			...
			  			<th style="width:20%;">Rating</th>
			  			<th style="width:15%;">Available Cases</th>			  			
			  			<th style="width:15%;">Handled Cases</th>			  			
			  			<th style="width:15%;">Total Completion Percentages</th>			  			
			  			<th style="width:10%;"></th>
			  		</tr>
			  	</thead>
			  	<tbody>
			  ...
			  <div class="col-md-6">
			  	<div class="form-group">
				    <label for="subTotal" class="col-sm-3 control-label">Sub Rating</label>
				    <div class="col-sm-9">
				  ...
				  <div class="form-group">
				    <label for="totalAmount" class="col-sm-3 control-label">Total Archrived</label>
				    <div class="col-sm-9">
				  ...
				  <div class="form-group">
				    <label for="discount" class="col-sm-3 control-label">Penality in Case</label>
				    <div class="col-sm-9">
				      <input type="text" class="form-control" id="discount" name="discount" onkeyup="discountFunc()" autocomplete="off" value="<?php echo $data[7] ?>" />
				    </div>
				  </div> <!--/form-group-->	
				  <div class="form-group">
				    <label for="grandTotal" class="col-sm-3 control-label">Case Pendings</label>
				    <div class="col-sm-9">
			  ...
			  <div class="col-md-6">
			  	<div class="form-group">
				    <label for="paid" class="col-sm-3 control-label">No of Appealing</label>
				    <div class="col-sm-9">
				      <input type="text" class="form-control" id="paid" name="paid" autocomplete="off" onkeyup="paidAmount()" value="<?php echo $data[9] ?>"  />
				    </div>
				  </div> <!--/form-group-->			  
				  <div class="form-group">
				    <label for="due" class="col-sm-3 control-label">Remaining Hiring</label>
				    <div class="col-sm-9">
				  ...
				  <div class="form-group">
				    <label for="clientContact" class="col-sm-3 control-label">Case Results</label>
				    <div class="col-sm-9">
				      <select class="form-control" name="paymentType" id="paymentType" >
				      	<option value="">~~SELECT~~</option>
				  ...
				  <div class="form-group">
				    <label for="clientContact" class="col-sm-3 control-label">Court Location</label>
				    <div class="col-sm-9">
				      <select class="form-control" name="paymentPlace" id="paymentPlace">
				      	<option value="">~~SELECT~~</option>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><i class="glyphicon glyphicon-edit"></i> Edit Case Detai</h4>
      </div>      
      ...
      <div class="modal-body form-horizontal" style="max-height:500px; overflow:auto;" >
      	...
      	<div class="paymentOrderMessages"></div>
			  ...
			  <div class="form-group">
			    <label for="due" class="col-sm-3 control-label">Penalities</label>
			    <div class="col-sm-9">
			      <input type="text" class="form-control" id="due" name="due" disabled="true" />					
			    </div>
			  </div> <!--/form-group-->		
			  <div class="form-group">
			    <label for="payAmount" class="col-sm-3 control-label">Archived Cases</label>
			    <div class="col-sm-9">
			      <input type="text" class="form-control" id="payAmount" name="payAmount"/>					      
			    </div>
			  </div> <!--/form-group-->		
			  <div class="form-group">
			    <label for="clientContact" class="col-sm-3 control-label">Case Mode</label>
			    <div class="col-sm-9">
			      <select class="form-control" name="paymentType" id="paymentType" >
			      	<option value="">~~SELECT~~</option>
			      	<option value="1">Completed</option>
			      	<option value="2">Partially Going</option>
			      	<option value="3">Not Completed</option>
			      </select>
			    </div>
			  </div> <!--/form-group-->							  
			  <div class="form-group">
			    ...
			    <div class="col-sm-9">
			      <select class="form-control" name="paymentStatus" id="paymentStatus">
			      	<option value="">~~SELECT~~</option>
			      	<option value="1">Full Success</option>
			      	<option value="2">Advance Success</option>
			      	<option value="3">Not Successed</option>
			      </select>
			    </div>
			  </div> <!--/form-group-->							  				  
...
<div class="modal fade" tabindex="-1" role="dialog" id="removeOrderModal">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title"><i class="glyphicon glyphicon-trash"></i> Remove Cases</h4>
      </div>
